...
//        Name name = new ImmutableName("John", "Doe", "Jr.");
//        Address address = new ImmutableAddress("123 Main St", "", "Anytown", "CA", 12345);
//        User user = new User(name, address);
//
//        Assertions.assertEquals("John", user.getName().getFirstName());
